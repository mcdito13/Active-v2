...
function runQuery(err, result, res) {
    if(err) {
        res.send(err);
    } else {
        console.log('Adding activity to activity log: ');
        console.log(result);
        // update the users profile page after adding the activity
...
router.get('/edit', function(req, res) {
    ...
    var userId = req.query;
    console.log('user_id: ' + userId);
    activityLog_dal.edit(req.query, function(err, result) {
        if(err) {
            res.send(err);
        } else {
            console.log('Adding activity to activity log: ');
...
router.get('/delete', function(req, res) {
    console.log('Activitylog delete data:');
    console.log(req.query);
    var userId = req.query;
    console.log('user_id: ' + userId);
    activityLog_dal.delete(req.query, function(err, result) {
        if(err) {
            res.send(err);
        } else {
            console.log('Deleting activity from activity log: ');
            console.log(result);
            // update the users profile page after adding the activity
            user_dal.getUserById(userId, function (err, user_info_result) {
                console.log('Checking if user exists...');
